"""
Django settings for pinterest_clone_4 project.
...
ROOT_URLCONF = 'pinterest_clone_4.urls'
...
WSGI_APPLICATION = 'pinterest_clone_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Pinterest Clone Support <support@pinterest-clone-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pinterest_clone_4 API",
    "DESCRIPTION": "API documentation for pinterest_clone_4 App",
    "VERSION": "v1",
}
